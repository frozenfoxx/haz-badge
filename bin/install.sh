...
finalize_message()
{
  eval echo "[+] The haz-badge stack is now installed and ready to go." ${STD_LOG_ARG}
...
usage()
{
  ...
  echo "    -L | --Log             enable logging (target: '[LOG_PATH]/haz_badge_install.log')"
}
